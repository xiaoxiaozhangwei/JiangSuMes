        ...
        <div class="dept_info col-sm-10">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    ...
                    <div align="center">
                        <h4 style="font-size:40px; color: #ff5a19;" >组装站-重工Barcode号码绑定</h4></div>
                        ...
                        <form action="" name="link" class="link">
                            <table class="table">
                                <tr >
                                    <td>
                                        工单号码：
                                        <!--  <input  type="text" value="${mo}"  name="moId" id="getmoid" />-->
                                          <select name="moId" id="getmoid"  onchange="updatemoid()" >
                                           <option value="">请选择</option>
                                       </select>
                                    </td>
                                    <td>工单量：<input type="text" name="monum" id="getmonum"   ></td>
                                    <td>工单剩余量：<input type="text" name="moremain"  id="getmoremain"  /></td>
                                ...
                                <tr>
                                    ...
                                    <td>已使用次数：<input type="text" name="times" id="getimes"  ></td>
                                ...
                                <tr>
                                    <td>
                                        产品SN：<input type="text" name="productionSN" id="inputproduct"  onkeydown="onKeyUsername();" onfocus="checkNull1()"/>
                                    ...
                                    <td>
                                        PCBA SN：<input type="text" name="pcbaSN" id="inputpcba" onfocus="checkNull()" onkeydown="check()"/>
